...
//    public static final String HEADPIC  = "http://118.178.227.194:8087/";
    ...
    public static final int OBSERVER_CANCEL_1 = 100;
    public static final int OBSERVER_CANCEL_2 = 200;
    public static final int OBSERVER_REFRASH = 300;


    public static final String LOGINSP = "login_prefences";
    public static final String USERINFO = "user_prefences";
    public static String TRAIL = "trail_setting";
    public static String PIGEONSTART = "pigeonstart";

    public static final String test = "18033";
